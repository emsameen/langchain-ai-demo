...
from langchain_rag.rag.pinecone_manager import PineconeManager
from langchain_rag.config.settings import logger
from langchain_rag.rag.vector_storage import VectorStorageHandler
from langchain_rag.rag.embedding_manager import EmbeddingManager
from langchain_rag.rag.embeddings import EmbeddingOutputType
from langchain_rag.rag.filetypes import FileType
...
SAMPLE_METADATA = [
    ...
    {"category": "proverb", "language": "english", "words": 10},
...
def main():
    ...
    manager.upsert_from_embeddings(
    ...
    # Step 7: Query the index with a text
    ...
    # Step 8: Fetch specific vectors by ID
